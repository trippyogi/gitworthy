...
export const SignalSchema = z.enum(['in_flight', 'shipped', 'released_fix', 'duplicate', 'no_pr_path', 'linked_pr_open', 'linked_pr_merged', 'linked_pr_closed', 'assigned', 'needs_repro', 'claim_required']);
