...
export function renderBrief(brief: Brief, format: BriefFormat): string {
  ...
  if (format === 'markdown') {
    return [
      ...
      `## Contribution policy`,
      '',
      renderItems(brief.contribution_policy),
      '',
      `## Claim requirements`,
      '',
      renderItems(brief.claim_requirements),
      '',
      `## Linked work`,
      '',
      renderItems(brief.linked_work),
      '',
      `## Prior attempts`,
      '',
      renderItems(brief.prior_attempts),
      '',
      `## Named paths and symbols`,
      '',
      `Paths:`,
      renderList(brief.named_paths_symbols.paths),
      '',
      `Symbols:`,
      renderList(brief.named_paths_symbols.symbols),
      '',
      `## Next actions`,
      '',
